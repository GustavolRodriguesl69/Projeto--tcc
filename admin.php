...
$sql = "SELECT id_cliente, nome, email, endereco, ativo, tipo FROM tb_clientes";
        ...
        if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
              echo "<tr>
                      ...
                      <td>{$row['tipo']}</td>
                      <td>
                        <img class='hb_icon_r' src='../Icones/editar.png' onclick='window.location.href=\"./editar_usuario.php?id={$row['id_cliente']}\"'>
                        <img class='hb_icon_r' src='../Icones/deletar.png' onclick='window.location.href=\"./deletar_usuario.php?id={$row['id_cliente']}\"'>
                      </td>
                    </tr>";
          } 
        } else {
